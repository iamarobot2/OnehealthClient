// src/components/HcpDashHeader.jsx
        ...
        <nav>
          <ul className="flex flex-col text-md gap-4">
            <li className="hover:text-blue-400">
              <Link to={"/hcp-dashboard"}>Dashboard</Link>
            </li>
            <li className="hover:text-blue-400">
              <Link to={"/hcp-dashboard/appointments"}>Appointments</Link>
            </li>
            <li className="hover:text-blue-400">
              <Link to={"/hcp-dashboard/patientRecord"}>Patient Record</Link>
            </li>
          </ul>
        </nav>
